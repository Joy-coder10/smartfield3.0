    ...
    <body class="top-navbar-fixed">
                                                            ...
                                                            foreach ($results as $result) {   ?>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <a data-msg="Do you really want to delete this result?" class="delete-result" href="?act=del&stid=<?php echo htmlentities($result->StudentId); ?>">
        ...
        <script>
            ...
            $(document).ready(function(){
                $(".delete-result").each(function(){
                    $(this).on("click", function(){
                        event.preventDefault();

                        var default_msg = "Do you really want to delete this result?";
                        ...
                        if(confirm(default_msg)) {
                            location.href = "manage-results.php" + $(this).attr("href");
                        } 
                    });
                }); 
            });
