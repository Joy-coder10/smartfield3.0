<div class="left-sidebar bg-black-300 box-shadow ">
    <div class="sidebar-content">
        <div class="user-info closed">
            <small class="info">Designed by: ICE Hub</small>
        </div>
        <!-- /.user-info -->
        ...
        <div class="sidebar-nav">
            <ul class="side-nav color-gray">
                ...
                <li>
                    <a href="dashboard-teacher.php"><i class="fa fa-dashboard"></i> <span>Dashboard</span> </a>
               ...
               <!--  <li class="has-children">
                    <a href="#"><i class="fa fa-file-text"></i> <span>Academic Session</span> <i class="fa fa-angle-right arrow"></i></a>
                    <ul class="child-nav">
                        <li><a href="create-session.php"><i class="fa fa-bars"></i> <span>Create New Session</span></a></li>
                        <li><a href="manage-sessions.php"><i class="fa fa fa-server"></i> <span>Manage Sessions</span></a></li>
            ...
            <!-- <li class="has-children">
                <a href="#"><i class="fa fa-briefcase"></i> <span>Teachers</span> <i class="fa fa-angle-right arrow"></i></a>
                <ul class="child-nav">
            ...
            <li class="has-children">
                ...
                <ul class="child-nav">
                    ...
                    <li><a href="manage-results-teacher.php"><i class="fa fa fa-server"></i> <span>Manage Result</span></a></li>

                </ul>
            <li><a href="change-password-teacher.php"><i class="fa fa fa-server"></i> <span> Change Password</span></a></li>
