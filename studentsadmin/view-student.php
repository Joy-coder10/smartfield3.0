...
?>
    ...
    <head>
        ...
        <title>SMS Admin| View Student < </title>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-5">
                                    <?php  
                                        $studentid = $_GET['stid'];
                                        $sql ="SELECT image, status FROM tblstudents WHERE StudentId = $studentid";
                                        $query= $dbh -> query($sql);
                                            ...
                                            <form class="form-horizontal" method="post">
                                                ...
                                                if ($query->rowCount() > 0) {
                                                    foreach ($results as $result) {  ?>
                                                            ...
                                                            <div class="col-sm-10">
                                                                <p class="form-control"> <?php echo htmlentities($result->StudentName) ?>
                                                                </p>
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <p class="form-control"><?php echo htmlentities($result->StudentEmail) ?>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <p class="form-control"> <?php echo htmlentities($result->DOB) ?> </p>
                                                            </div>
                                                        </div>
                                                        
                                                        
                                                        <div class="form-group">
                                                            <label for="date" class="col-sm-2 control-label">School fees Installment</label>
                                                            <div class="col-sm-10">
                                                                <p class="form-control"> <?php echo htmlentities($result->installment) ?> </p>
                                                            </div>
                                                        </div>

                                                        <div class="form-group">
                                                            <label for="date" class="col-sm-2 control-label">School Fees </label>
                                                            <div class="col-sm-10">
                                                                <p class="form-control"> <?php echo htmlentities($result->paid) ?> </p>
                                                            </div>
                                                        </div>
