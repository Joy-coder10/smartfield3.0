...
if(strlen($_SESSION['alogin'])=="")
    ...
    header("Location: index.php"); 
        ...
        if (isset($_GET['act']) && isset($_GET['subjectid'])) {
...
<a class="delete-subject"  href="?act=del&subjectid=<?php echo htmlentities($result->id);?>" data-msg="Do you really want to delete this subject?">
        ...
        <script>
            ...
            $(".delete-subject").each(function(){
                $(this).on("click", function(){
                    ...
                    var default_msg = "Do you really want to delete this subject?";
                    ...
                    if(confirm(default_msg)) {
                        location.href = "manage-subjects.php" + $(this).attr("href");
                    } 
                });
            });
        });
