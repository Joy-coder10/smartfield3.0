...
if (strlen($_SESSION['alogin']) == "") {
    ...
    if (isset($_POST['submit'])) {
        ...
        $classid = $_POST['class'];
        $dob = $_POST['dob'];
        $sql = "INSERT INTO  tblteachers(name,email,class,gender,date_created,image) VALUES(:studentname,:studentemail,:classid,:gender,:dob,:image)";
                                    ...
                                    <div class="panel">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <form class="form-horizontal" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    <label for="date" class="col-sm-2 control-label">Date Registered</label>
                                                    <div class="col-sm-10">
                                                ...
                                                <div class="form-group">
                                                    <label for="date" class="col-sm-2 control-label">Teacher Image</label>
                                                    <div class="col-sm-10">
