...
$qery = "SELECT   tblstudents.StudentName,tblstudents.RollId,tblstudents.RegDate,tblstudents.StudentId,tblstudents.Status, tblstudents.remark,tblclasses.ClassName,tblclasses.Section from tblstudents join tblclasses on tblclasses.id=tblstudents.ClassId where tblstudents.RollId=? and tblstudents.ClassId=?";
...
while ($result = $res1->fetch_object()) {  ?>
  <p><b>Student Name :</b> <?php echo htmlentities($sessionname); ?></p>
  <p><b>Student Name :</b> <?php echo htmlentities($result->StudentName); ?></p>
  <p><b>Teacher's remark :</b> <?php echo htmlentities($result->remark); ?></p>
