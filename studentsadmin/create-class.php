                                                ...
                                                <form method="post">
                                                    <div class="form-group has-success">
                                                		...
                                                		<div class="">
                                                            ...
                                                            <span class="help-block">Eg- Creche, Nursery, Primary etc</span>
                                                		</div>
                                                	</div>
                                                       <div class="form-group has-success">
                                                     ...
                                                     <div class="form-group has-success">
                                                        <label for="success" class="control-label">Sub class</label>
                                                        <div class="">
                                                            <input type="text" name="section" class="form-control" required="required" id="success">
                                                            <span class="help-block">Eg- nursery one (A, B or C)</span>
                                                        </div>
                                                    </div>
  <div class="form-group has-success">
