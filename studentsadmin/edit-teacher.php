...
if (strlen($_SESSION['alogin']) == "") {
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = "update tblteachers set name=:teachername,email=:teacheremail,class=:classid,gender=:gender,date_updated=:date_updated,image=:image where id=:tid ";
                    ...
                    <div class="main-page">
                        ...
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Edit Teacher Admission</h2>
                            ...
                            <div class="row breadcrumb-div">
                                <div class="col-md-6">
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="active">Edit Teacher Admission</li>
                                    </ul>
                                </div>
                                    ...
                                    <div class="panel">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <form class="form-horizontal" method="post" enctype="multipart/form-data">
                                                ...
                                                $sql = "SELECT tblteachers.id,tblteachers.name,tblteachers.email,tblteachers.class,tblteachers.gender,tblteachers.date_created,tblclasses.ClassName,tblclasses.Section from tblteachers join tblclasses on tblclasses.id=tblteachers.class where tblteachers.id=:tid";
                                                $query = $dbh->prepare($sql);
                                                $query->bindParam(':tid', $tid, PDO::PARAM_STR);
                                                $query->execute();
                                                ...
                                                if ($query->rowCount() > 0) {
                                                    ...
                                                    <div class="form-group">
                                                            <label for="Image" class="col-sm-2 control-label">Teacher Image</label>
                                                            <div class="col-sm-10">
