...
if (strlen($_SESSION['alogin']) == "") {
    ...
    if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        $sql = "INSERT INTO  tblstudents(StudentName,RollId,StudentEmail,Gender,ClassId,DOB,Status, remark, image) VALUES(:studentname,:roolid,:studentemail,:gender,:classid,:dob,:status, '', :image)";
                                    ...
                                    <div class="panel">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <form class="form-horizontal" method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    <label for="date" class="col-sm-2 control-label">Student Image</label>
                                                    <div class="col-sm-10">
