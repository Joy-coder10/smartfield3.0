...
session_start();
error_reporting(0);
include('studentsadmin/includes/config.php'); ?>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12 search-wrap">
							...
							<form action="studentsadmin/result.php" method="post" class="colorlib-form">
				              	<div class="row">
				                <div class="col-md-3">
				                  <div class="form-group">
				                    <div class="form-field">
				                     <input type="text" class="form-control" id="rollid" placeholder="Roll number" autocomplete="off" name="rollid">
				                    </div>
				                  </div>
				                </div>
				                <div class="col-md-3">
				                	<div class="form-group">
				                	 	<div class="form-field">
		                                    ...
		                                    <select name="class" class="form-control" id="default" required="required" style="background: #302a39; color: white">
				                ...
				                <div class="col-md-3">
                            			<div class="form-group"> 
                            				<div class="form-field">
			                            		<i class="icon icon-arrow-down3"></i>
			                                    <select name="session" class="form-control" id="default" required="required" style="background: #302a39; color: white">
				                ...
				                <div class="col-md-3">
				                  <a href="#"><button type="submit" name="submit" id="submit" class="btn btn-success btn-block">
				                  		Check Result <i class="fa fa-check"> </i> </button>
				                  </a>
				                </div>
				              </div>
				            </form>
